...
time = y1y2_tmp.time;
mv_time = mv1_tmp.time;

y1_avg = (exp1_y1 + exp2_y1 + exp3_y1)/3;
y2_avg = (exp1_y2 + exp2_y2 + exp3_y2)/3;

u1_avg = (exp1_u1 + exp2_u1 + exp3_u1)/3;
u2_avg = (exp1_u2 + exp2_u2 + exp3_u2)/3;

mv1_avg = (exp1_mv1 + exp2_mv1 + exp3_mv1)/3;
mv2_avg = (exp1_mv2 + exp2_mv2 + exp3_mv2)/3;

% plot(exp1_time,y1_avg,'b-', exp1_time,exp1_u1,'r-')
% plot(exp1_time,y2_avg,'b-', exp1_time,exp1_u2,'r-')