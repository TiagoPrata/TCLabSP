...
% f1 = @(level) writePWMDutyCycle(a,'D10',max(0,min(100,level))*0.5/100);
f1 = @(level, disturbanceLevel) writePWMVoltage(a,'D10', max(0,min(5,interp1([0,100],[0,2.4],level))));
f2 = @(level, disturbanceLevel) writePWMVoltage(a,'D11', max(0,min(5,interp1([0,100],[0,2.4],level))));